                ...
                <div class="card-body">
                    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="instruction" id="editor" class="form-control">{{ old('instruction') }}</textarea>
                            @error('instruction') <div class="text-danger">{{ $message }}</div> @enderror
                        </div>
                        ...
                        <div id="features-container" class="mb-3">
                            ...
                            <div class="feature-item d-flex gap-2 mt-2">
                                ...
                                <input class="form-control" name="features[0][description]" type="text" placeholder="Description">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="count" id="count" class="form-control" value="{{ old('count') }}" required>
